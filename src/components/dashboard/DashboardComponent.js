...
import { mainListItems, secondaryListItems } from './LineItemsComponent';
...
class Dashboard extends React.Component {
    ...
    render() {
        const { classes, children, isDrawerOpen, openDrawerAction, closeDrawerAction} = this.props;
        ...
        <div className={classes.root}>
            ...
            <div className={classes.toolbarIcon}>
                <IconButton onClick={closeDrawerAction}>
                <ChevronLeftIcon />
                </IconButton>
            </div>
            <Divider />
